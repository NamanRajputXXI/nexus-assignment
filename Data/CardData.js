import logo from "../assets/v3/client/logo-ibm.webp";
import logoequity from "../assets/v3/client/logo-equity.webp";
import complogo from "../assets/v3/client/logo-audi.webp";
import energyProducer from "../assets/v3/client/logo-aramco.webp";

const data = [
  {
    logo: "../assets/v3/client/logo-ibm.webp",
  ...
  {
    logo: "../assets/v3/client/logo-equity.webp",
    name: "4th Strongest Bank",
    about:
  ...
  {
    logo: "../assets/v3/client/logo-audi.webp",
    name: "Intelligence on wheel",
    about:
  ...
  {
    logo: "../assets/v3/client/logo-aramco.webp",
  ...
  {
    logo: "../assets/v3/client/logo-byju.webp",
    name: "Cloud-Native Insurance",
    about:
  ...
  {
    logo: "../assets/v3/client/logo-insurity.webp",
  ...
  {
    logo: "../assets/v3/client/logo-penny.webp",
    name: "Open Source Giant",
    about:
  ...
  {
    logo: "../assets/v3/client/logo-baanx.webp",
    name: "Crypto Bank",
    about:
  ...
  {
    logo: "../assets/v3/client/logo-inchcape.webp",
    name: "",
    about:
      "From cloud computing to artificial intelligence, IBM's cutting-edge technologies and expertise have helped countless businesses stay ahead of the curve in today's digital world",
  },
  {
    logo: "../assets/v3/client/logo-ifit.webp",
    name: "Global Technology",
    about:
      "From cloud computing to artificial intelligence, IBM's cutting-edge technologies and expertise have helped countless businesses stay ahead of the curve in today's digital world",
  },
  {
    logo: "../assets/v3/client/logo-linux.webp",
    name: "Open Source Giant",
    about:
      "From cloud computing to artificial intelligence, IBM's cutting-edge technologies and expertise have helped countless businesses stay ahead of the curve in today's digital world",
  },
  {
    logo: "../assets/v3/client/logo-payyit.webp",
    name: "Smooth Invoicing",
    about:
